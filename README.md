...
A curated list of awesome MySQL free and opensource software, libraries and resources. [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 438,409 | 🐛 71 | 📅 2026-01-28
...
* [Prometheus](https://github.com/prometheus/prometheus) ⭐ 62,794 | 🐛 758 | 🌐 Go | 📅 2026-02-18/[mysqld\_exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,405 | 🐛 184 | 🌐 Go | 📅 2026-02-16 - Time series database for real-time monitoring and alerting.
...
* [Dolphie](https://github.com/charles-001/dolphie) ⭐ 1,110 | 🐛 1 | 🌐 Python | 📅 2026-02-17 - a modern terminal tool for real-time analytics into MySQL/MariaDB & ProxySQL
* [sql-tap](https://github.com/mickamy/sql-tap) ⭐ 898 | 🐛 0 | 🌐 Go | 📅 2026-02-18 - Real-time SQL traffic viewer.
...
* [Dumpling](https://github.com/pingcap/tidb/tree/master/dumpling) ⭐ 39,794 | 🐛 5,673 | 🌐 Go | 📅 2026-02-19 - Logical, parallel backup/dumper tool for MySQL/TiDB written in GoLang - support csv format output and integrated as library
* [Databasus](https://github.com/databasus/databasus) ⭐ 5,601 | 🐛 3 | 🌐 Go | 📅 2026-02-18 - tool for scheduled MySQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
* [MyDumper](https://github.com/mydumper/mydumper) ⭐ 3,029 | 🐛 47 | 🌐 C | 📅 2026-02-11 - Logical, parallel backup/dumper tool for MySQL
...
* [Portabase](https://github.com/Portabase/portabase) ⭐ 325 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-18 - Agent-based platform for MySQL backups and restores with decentralized execution and centralized orchestration.

## Benchmarking

*Tools to stress your servers*

* [Sysbench](https://github.com/akopytov/sysbench) ⭐ 6,679 | 🐛 213 | 🌐 C | 📅 2025-03-09 - a modular, cross-platform and multi-threaded benchmark tool.
...
* [go-sql-driver](https://github.com/go-sql-driver/mysql) ⭐ 15,421 | 🐛 74 | 🌐 Go | 📅 2025-06-13 - a lightweight and fast MySQL-Driver for Go's (golang) database/sql package.
...
* [ballerinax/mysql](https://github.com/ballerina-platform/module-ballerinax-mysql) ⭐ 111 | 🐛 4 | 🌐 Ballerina | 📅 2026-02-18 - Official Ballerina connector for MySQL.
...
* [Flywaydb](https://github.com/flyway/flyway) ⭐ 9,540 | 🐛 242 | 🌐 Java | 📅 2026-02-12 - Database migrations; Evolve your database schema easily and reliably across all your instances
* [Liquibase](https://github.com/liquibase/liquibase) ⭐ 5,428 | 🐛 687 | 🌐 Java | 📅 2026-02-18 - Source control for your database
...
* [DBeaver](https://github.com/dbeaver/dbeaver/) ⭐ 48,721 | 🐛 3,235 | 🌐 Java | 📅 2026-02-18 - A cross-platform SQL and NoSQL database client.
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,798 | 🐛 917 | 🌐 PHP | 📅 2026-02-19 - a free software tool written in PHP, intended to handle the administration of MySQL over the Web.
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,300 | 🐛 233 | 🌐 Objective-C | 📅 2026-02-12 - a Mac database management application for working with MySQL databases.
* [Adminer](https://github.com/vrana/adminer/) ⭐ 7,268 | 🐛 23 | 🌐 PHP | 📅 2026-02-12 - Database management in a single PHP file.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 5,806 | 🐛 421 | 🌐 Pascal | 📅 2026-02-18 - MySQL GUI frontend for Windows.
...
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 965 | 🐛 177 | 🌐 Go | 📅 2026-02-18 - An open-source platform for managing and monitoring MySQL performance.
...
* [replication-manager](https://github.com/signal18/replication-manager) ⭐ 727 | 🐛 143 | 🌐 Go | 📅 2026-02-18 - a high availability solution to manage MariaDB 10.x and MySQL & Percona Server 5.7 GTID replication topologies.
...
* [ProxySQL](https://github.com/sysown/proxysql) ⭐ 6,624 | 🐛 1,103 | 🌐 C++ | 📅 2026-02-19 - High performance proxy for MySQL.
...
* [TiDB](https://github.com/pingcap/tidb) ⭐ 39,794 | 🐛 5,673 | 🌐 Go | 📅 2026-02-19 - A distributed HTAP database compatible with the MySQL protocol.
* [MySQL Server & MySQL Cluster](https://github.com/mysql/mysql-server) ⭐ 12,122 | 🐛 0 | 🌐 C++ | 📅 2026-01-22 - Official Oracle's MySQL server & MySQL Cluster distribution.
* [MariaDB](https://github.com/MariaDB/server) ⭐ 7,190 | 🐛 278 | 🌐 C++ | 📅 2026-02-18 - Community developed fork of MySQL server.
* [Percona Server](https://github.com/percona/percona-server) ⭐ 1,254 | 🐛 58 | 🌐 C++ | 📅 2026-02-18 - An enhanced, drop-in MySQL replacement.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 20,743 | 🐛 913 | 🌐 Go | 📅 2026-02-19 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [gh-ost](https://github.com/github/gh-ost/) ⭐ 13,217 | 🐛 322 | 🌐 Go | 📅 2026-02-10 - GitHub's online schema migration for MySQL.
...
* [Percona Toolkit](https://github.com/percona/percona-toolkit) ⭐ 1,449 | 🐛 27 | 🌐 Perl | 📅 2026-02-18 - a collection of advanced command-line tools to perform a variety of MySQL server and system tasks that are too difficult or complex to perform manually.
...
* [VillageSQL](https://github.com/villagesql/villagesql-server) ⭐ 90 | 🐛 15 | 🌐 C++ | 📅 2026-02-18 - A drop-in replacement for MySQL with extensions for the agentic AI era.
