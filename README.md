...
A curated list of awesome MySQL free and opensource software, libraries and resources. [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 438,708 | 🐛 70 | 📅 2026-01-28
...
* [Prometheus](https://github.com/prometheus/prometheus) ⭐ 62,853 | 🐛 756 | 🌐 Go | 📅 2026-02-19/[mysqld\_exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,406 | 🐛 184 | 🌐 Go | 📅 2026-02-16 - Time series database for real-time monitoring and alerting.
...
* [Dolphie](https://github.com/charles-001/dolphie) ⭐ 1,111 | 🐛 1 | 🌐 Python | 📅 2026-02-17 - a modern terminal tool for real-time analytics into MySQL/MariaDB & ProxySQL
* [sql-tap](https://github.com/mickamy/sql-tap) ⭐ 917 | 🐛 0 | 🌐 Go | 📅 2026-02-20 - Real-time SQL traffic viewer.
...
* [Dumpling](https://github.com/pingcap/tidb/tree/master/dumpling) ⭐ 39,844 | 🐛 5,676 | 🌐 Go | 📅 2026-02-19 - Logical, parallel backup/dumper tool for MySQL/TiDB written in GoLang - support csv format output and integrated as library
* [Databasus](https://github.com/databasus/databasus) ⭐ 5,614 | 🐛 6 | 🌐 Go | 📅 2026-02-18 - tool for scheduled MySQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
* [MyDumper](https://github.com/mydumper/mydumper) ⭐ 3,029 | 🐛 47 | 🌐 C | 📅 2026-02-19 - Logical, parallel backup/dumper tool for MySQL
...
* [Portabase](https://github.com/Portabase/portabase) ⭐ 330 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-19 - Agent-based platform for MySQL backups and restores with decentralized execution and centralized orchestration.
...
* [go-sql-driver](https://github.com/go-sql-driver/mysql) ⭐ 15,424 | 🐛 73 | 🌐 Go | 📅 2026-02-19 - a lightweight and fast MySQL-Driver for Go's (golang) database/sql package.
* [PyMySQL](https://github.com/PyMySQL/PyMySQL) ⭐ 7,840 | 🐛 24 | 🌐 Python | 📅 2025-08-24 - MySQL database connector for Python.
...
* [MySQL Connector/J](https://github.com/mysql/mysql-connector-j) ⭐ 1,010 | 🐛 1 | 🌐 Java | 📅 2026-01-22 - a standardized database driver for the Java platforms and development.
...
* [ballerinax/mysql](https://github.com/ballerina-platform/module-ballerinax-mysql) ⭐ 111 | 🐛 3 | 🌐 Ballerina | 📅 2026-02-19 - Official Ballerina connector for MySQL.
* [MyZql](https://github.com/speed2exe/myzql) ⭐ 67 | 🐛 5 | 🌐 Zig | 📅 2025-11-21 - MySQL and MariaDB driver in native Zig.
* [DBD::mysql](https://github.com/perl5-dbi/DBD-mysql) ⭐ 66 | 🐛 75 | 🌐 Perl | 📅 2026-02-19 - MySQL driver for the Perl5 Database Interface.
...
* [Flywaydb](https://github.com/flyway/flyway) ⭐ 9,541 | 🐛 242 | 🌐 Java | 📅 2026-02-12 - Database migrations; Evolve your database schema easily and reliably across all your instances
* [Liquibase](https://github.com/liquibase/liquibase) ⭐ 5,428 | 🐛 686 | 🌐 Java | 📅 2026-02-20 - Source control for your database
...
* [DBeaver](https://github.com/dbeaver/dbeaver/) ⭐ 48,740 | 🐛 3,230 | 🌐 Java | 📅 2026-02-19 - A cross-platform SQL and NoSQL database client.
* [ILLA Cloud](https://github.com/illacloud/illa-builder) ⭐ 12,374 | 🐛 43 | 🌐 TypeScript | 📅 2026-02-15 - Low-code internal tool builder integrated with Mysql, can be used as GUI for Mysql.
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,798 | 🐛 918 | 🌐 PHP | 📅 2026-02-20 - a free software tool written in PHP, intended to handle the administration of MySQL over the Web.
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,299 | 🐛 233 | 🌐 Objective-C | 📅 2026-02-20 - a Mac database management application for working with MySQL databases.
* [Adminer](https://github.com/vrana/adminer/) ⭐ 7,268 | 🐛 23 | 🌐 PHP | 📅 2026-02-12 - Database management in a single PHP file.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 5,807 | 🐛 408 | 🌐 Pascal | 📅 2026-02-19 - MySQL GUI frontend for Windows.
* [OmniDB: Web tool for database management](https://github.com/OmniDB/OmniDB) ⭐ 3,277 | 🐛 329 | 🌐 JavaScript | 📅 2023-02-01
* [pspg](https://github.com/okbob/pspg) ⭐ 2,691 | 🐛 0 | 🌐 C | 📅 2026-02-18 - provides a pager with enhanced visualization and navigation for tabular data. Originally implemented for PostgreSQL, but also supports MySQL.
...
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 965 | 🐛 172 | 🌐 Go | 📅 2026-02-19 - An open-source platform for managing and monitoring MySQL performance.
...
* [replication-manager](https://github.com/signal18/replication-manager) ⭐ 727 | 🐛 144 | 🌐 Go | 📅 2026-02-19 - a high availability solution to manage MariaDB 10.x and MySQL & Percona Server 5.7 GTID replication topologies.
...
* [ProxySQL](https://github.com/sysown/proxysql) ⭐ 6,624 | 🐛 1,107 | 🌐 C++ | 📅 2026-02-20 - High performance proxy for MySQL.
...
* [TiDB](https://github.com/pingcap/tidb) ⭐ 39,844 | 🐛 5,676 | 🌐 Go | 📅 2026-02-19 - A distributed HTAP database compatible with the MySQL protocol.
* [MySQL Server & MySQL Cluster](https://github.com/mysql/mysql-server) ⭐ 12,173 | 🐛 0 | 🌐 C++ | 📅 2026-01-22 - Official Oracle's MySQL server & MySQL Cluster distribution.
* [MariaDB](https://github.com/MariaDB/server) ⭐ 7,196 | 🐛 280 | 🌐 C++ | 📅 2026-02-19 - Community developed fork of MySQL server.
* [Percona Server](https://github.com/percona/percona-server) ⭐ 1,254 | 🐛 58 | 🌐 C++ | 📅 2026-02-19 - An enhanced, drop-in MySQL replacement.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 20,790 | 🐛 909 | 🌐 Go | 📅 2026-02-20 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [gh-ost](https://github.com/github/gh-ost/) ⭐ 13,218 | 🐛 322 | 🌐 Go | 📅 2026-02-10 - GitHub's online schema migration for MySQL.
...
* [Percona Toolkit](https://github.com/percona/percona-toolkit) ⭐ 1,450 | 🐛 28 | 🌐 Perl | 📅 2026-02-19 - a collection of advanced command-line tools to perform a variety of MySQL server and system tasks that are too difficult or complex to perform manually.
...
* [Swoof](https://github.com/StirlingMarketingGroup/swoof) ⭐ 28 | 🐛 1 | 🌐 Go | 📅 2026-02-19 - Ultra fast MySQL table importer that stages swaps through temporary tables and supports file/clipboard targets.
...
* [VillageSQL](https://github.com/villagesql/villagesql-server) ⭐ 90 | 🐛 16 | 🌐 C++ | 📅 2026-02-19 - A drop-in replacement for MySQL with extensions for the agentic AI era.
