...
A curated list of awesome MySQL free and opensource software, libraries and resources. [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,721 | 🐛 71 | 📅 2026-01-28

This list accepts and encourages pull requests. See [CONTRIBUTING](https://github.com/shlomi-noach/awesome-mysql/blob/master/CONTRIBUTING.md) ⭐ 2,543 | 🐛 14 | 🌐 Python | 📅 2026-02-15
...
* [Prometheus](https://github.com/prometheus/prometheus) ⭐ 62,710 | 🐛 765 | 🌐 Go | 📅 2026-02-15/[mysqld\_exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,403 | 🐛 184 | 🌐 Go | 📅 2026-01-27 - Time series database for real-time monitoring and alerting.
* [MySQLTuner-perl](https://github.com/major/MySQLTuner-perl) ⭐ 9,436 | 🐛 35 | 🌐 Perl | 📅 2026-02-14 - A script that allows you to review a MySQL installation quickly and make adjustments to increase performance and stability.
...
* [Dolphie](https://github.com/charles-001/dolphie) ⭐ 1,107 | 🐛 1 | 🌐 Python | 📅 2026-02-12 - a modern terminal tool for real-time analytics into MySQL/MariaDB & ProxySQL
* [innotop](https://github.com/innotop/innotop) ⭐ 798 | 🐛 26 | 🌐 Perl | 📅 2025-10-22 - a 'top' clone for MySQL with many features and flexibility.
* [sql-tap](https://github.com/mickamy/sql-tap) ⭐ 743 | 🐛 0 | 🌐 Go | 📅 2026-02-15 - Real-time SQL traffic viewer.
...
* [Dumpling](https://github.com/pingcap/tidb/tree/master/dumpling) ⭐ 39,742 | 🐛 5,663 | 🌐 Go | 📅 2026-02-16 - Logical, parallel backup/dumper tool for MySQL/TiDB written in GoLang - support csv format output and integrated as library
* [Databasus](https://github.com/databasus/databasus) ⭐ 5,541 | 🐛 0 | 🌐 Go | 📅 2026-02-14 - tool for scheduled MySQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
...
* [Portabase](https://github.com/Portabase/portabase) ⭐ 319 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-15 - Agent-based platform for MySQL backups and restores with decentralized execution and centralized orchestration.

## Benchmarking

*Tools to stress your servers*

* [Sysbench](https://github.com/akopytov/sysbench) ⭐ 6,676 | 🐛 213 | 🌐 C | 📅 2025-03-09 - a modular, cross-platform and multi-threaded benchmark tool.
...
* [node-mysql](https://github.com/mysqljs/mysql) ⭐ 18,843 | 🐛 172 | 🌐 JavaScript | 📅 2024-06-25 - A pure Nodejs Javascript client implementing the MySQL protocol.
...
* [ballerinax/mysql](https://github.com/ballerina-platform/module-ballerinax-mysql) ⭐ 111 | 🐛 4 | 🌐 Ballerina | 📅 2026-02-16 - Official Ballerina connector for MySQL.
...
* [Flywaydb](https://github.com/flyway/flyway) ⭐ 9,533 | 🐛 239 | 🌐 Java | 📅 2026-02-12 - Database migrations; Evolve your database schema easily and reliably across all your instances
...
* [DBeaver](https://github.com/dbeaver/dbeaver/) ⭐ 48,690 | 🐛 3,227 | 🌐 Java | 📅 2026-02-15 - A cross-platform SQL and NoSQL database client.
* [ILLA Cloud](https://github.com/illacloud/illa-builder) ⭐ 12,372 | 🐛 43 | 🌐 TypeScript | 📅 2026-02-15 - Low-code internal tool builder integrated with Mysql, can be used as GUI for Mysql.
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,796 | 🐛 912 | 🌐 PHP | 📅 2026-02-16 - a free software tool written in PHP, intended to handle the administration of MySQL over the Web.
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,296 | 🐛 233 | 🌐 Objective-C | 📅 2026-02-12 - a Mac database management application for working with MySQL databases.
* [Adminer](https://github.com/vrana/adminer/) ⭐ 7,265 | 🐛 21 | 🌐 PHP | 📅 2026-02-12 - Database management in a single PHP file.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 5,803 | 🐛 419 | 🌐 Pascal | 📅 2026-02-15 - MySQL GUI frontend for Windows.
* [OmniDB: Web tool for database management](https://github.com/OmniDB/OmniDB) ⭐ 3,275 | 🐛 329 | 🌐 JavaScript | 📅 2023-02-01
* [pspg](https://github.com/okbob/pspg) ⭐ 2,688 | 🐛 1 | 🌐 C | 📅 2026-02-15 - provides a pager with enhanced visualization and navigation for tabular data. Originally implemented for PostgreSQL, but also supports MySQL.
...
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 965 | 🐛 171 | 🌐 Go | 📅 2026-02-16 - An open-source platform for managing and monitoring MySQL performance.
...
* [ProxySQL](https://github.com/sysown/proxysql) ⭐ 6,620 | 🐛 1,103 | 🌐 C++ | 📅 2026-02-15 - High performance proxy for MySQL.
...
* [myanon](https://github.com/ppomes/myanon) ⭐ 113 | 🐛 0 | 🌐 C | 📅 2026-02-15 - Streaming anonymizer for MySQL dump files, reading mysqldump output from stdin and writing anonymized data to stdout. Supports deterministic hashing, fixed values, JSON field anonymization, and Python extensions.
...
* [TiDB](https://github.com/pingcap/tidb) ⭐ 39,742 | 🐛 5,663 | 🌐 Go | 📅 2026-02-16 - A distributed HTAP database compatible with the MySQL protocol.
* [MySQL Server & MySQL Cluster](https://github.com/mysql/mysql-server) ⭐ 12,078 | 🐛 0 | 🌐 C++ | 📅 2026-01-22 - Official Oracle's MySQL server & MySQL Cluster distribution.
* [MariaDB](https://github.com/MariaDB/server) ⭐ 7,176 | 🐛 276 | 🌐 C++ | 📅 2026-02-16 - Community developed fork of MySQL server.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 20,697 | 🐛 924 | 🌐 Go | 📅 2026-02-15 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [gh-ost](https://github.com/github/gh-ost/) ⭐ 13,210 | 🐛 322 | 🌐 Go | 📅 2026-02-10 - GitHub's online schema migration for MySQL.
...
* [VillageSQL](https://github.com/villagesql/villagesql-server) ⭐ 80 | 🐛 17 | 🌐 C++ | 📅 2026-02-12 - A drop-in replacement for MySQL with extensions for the agentic AI era.
