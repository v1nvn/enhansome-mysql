...
A curated list of awesome MySQL free and opensource software, libraries and resources. [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,923 | 🐛 71 | 📅 2026-01-28
...
* [Prometheus](https://github.com/prometheus/prometheus) ⭐ 62,722 | 🐛 762 | 🌐 Go | 📅 2026-02-16/[mysqld\_exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,404 | 🐛 184 | 🌐 Go | 📅 2026-02-16 - Time series database for real-time monitoring and alerting.
...
* [Dolphie](https://github.com/charles-001/dolphie) ⭐ 1,108 | 🐛 1 | 🌐 Python | 📅 2026-02-17 - a modern terminal tool for real-time analytics into MySQL/MariaDB & ProxySQL
* [sql-tap](https://github.com/mickamy/sql-tap) ⭐ 821 | 🐛 2 | 🌐 Go | 📅 2026-02-15 - Real-time SQL traffic viewer.
...
* [Dumpling](https://github.com/pingcap/tidb/tree/master/dumpling) ⭐ 39,744 | 🐛 5,665 | 🌐 Go | 📅 2026-02-17 - Logical, parallel backup/dumper tool for MySQL/TiDB written in GoLang - support csv format output and integrated as library
* [Databasus](https://github.com/databasus/databasus) ⭐ 5,557 | 🐛 1 | 🌐 Go | 📅 2026-02-14 - tool for scheduled MySQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
...
* [Portabase](https://github.com/Portabase/portabase) ⭐ 320 | 🐛 8 | 🌐 TypeScript | 📅 2026-02-16 - Agent-based platform for MySQL backups and restores with decentralized execution and centralized orchestration.
...
* [go-sql-driver](https://github.com/go-sql-driver/mysql) ⭐ 15,421 | 🐛 73 | 🌐 Go | 📅 2025-06-13 - a lightweight and fast MySQL-Driver for Go's (golang) database/sql package.
...
* [MariaDB Connector/J](https://github.com/mariadb-corporation/mariadb-connector-j) ⭐ 357 | 🐛 5 | 🌐 Java | 📅 2026-02-16 - LGPL-licensed MariaDB Client Library for Java Applications.
...
* [Flywaydb](https://github.com/flyway/flyway) ⭐ 9,536 | 🐛 239 | 🌐 Java | 📅 2026-02-12 - Database migrations; Evolve your database schema easily and reliably across all your instances
* [Liquibase](https://github.com/liquibase/liquibase) ⭐ 5,424 | 🐛 684 | 🌐 Java | 📅 2026-02-16 - Source control for your database
...
* [DBeaver](https://github.com/dbeaver/dbeaver/) ⭐ 48,697 | 🐛 3,229 | 🌐 Java | 📅 2026-02-16 - A cross-platform SQL and NoSQL database client.
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,796 | 🐛 911 | 🌐 PHP | 📅 2026-02-16 - a free software tool written in PHP, intended to handle the administration of MySQL over the Web.
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,299 | 🐛 233 | 🌐 Objective-C | 📅 2026-02-12 - a Mac database management application for working with MySQL databases.
* [Adminer](https://github.com/vrana/adminer/) ⭐ 7,267 | 🐛 23 | 🌐 PHP | 📅 2026-02-12 - Database management in a single PHP file.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 5,803 | 🐛 421 | 🌐 Pascal | 📅 2026-02-16 - MySQL GUI frontend for Windows.
...
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 965 | 🐛 172 | 🌐 Go | 📅 2026-02-17 - An open-source platform for managing and monitoring MySQL performance.
...
* [ProxySQL](https://github.com/sysown/proxysql) ⭐ 6,623 | 🐛 1,102 | 🌐 C++ | 📅 2026-02-17 - High performance proxy for MySQL.
...
* [myanon](https://github.com/ppomes/myanon) ⭐ 113 | 🐛 0 | 🌐 C | 📅 2026-02-17 - Streaming anonymizer for MySQL dump files, reading mysqldump output from stdin and writing anonymized data to stdout. Supports deterministic hashing, fixed values, JSON field anonymization, and Python extensions.
...
* [TiDB](https://github.com/pingcap/tidb) ⭐ 39,744 | 🐛 5,665 | 🌐 Go | 📅 2026-02-17 - A distributed HTAP database compatible with the MySQL protocol.
* [MySQL Server & MySQL Cluster](https://github.com/mysql/mysql-server) ⭐ 12,081 | 🐛 0 | 🌐 C++ | 📅 2026-01-22 - Official Oracle's MySQL server & MySQL Cluster distribution.
* [MariaDB](https://github.com/MariaDB/server) ⭐ 7,183 | 🐛 278 | 🌐 C++ | 📅 2026-02-17 - Community developed fork of MySQL server.
* [Percona Server](https://github.com/percona/percona-server) ⭐ 1,254 | 🐛 58 | 🌐 C++ | 📅 2026-02-16 - An enhanced, drop-in MySQL replacement.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 20,698 | 🐛 926 | 🌐 Go | 📅 2026-02-16 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [gh-ost](https://github.com/github/gh-ost/) ⭐ 13,212 | 🐛 322 | 🌐 Go | 📅 2026-02-10 - GitHub's online schema migration for MySQL.
...
* [Percona Toolkit](https://github.com/percona/percona-toolkit) ⭐ 1,449 | 🐛 27 | 🌐 Perl | 📅 2026-02-16 - a collection of advanced command-line tools to perform a variety of MySQL server and system tasks that are too difficult or complex to perform manually.
...
* [VillageSQL](https://github.com/villagesql/villagesql-server) ⭐ 86 | 🐛 17 | 🌐 C++ | 📅 2026-02-12 - A drop-in replacement for MySQL with extensions for the agentic AI era.
